...
/**
 * Test put object tagging response for FSO bucket.
 */
public class TestS3PutObjectTaggingResponseWithFSO extends TestS3PutObjectTaggingResponse {
  ...
  @Override
  protected S3PutObjectTaggingResponse getPutObjectTaggingResponse(OmKeyInfo omKeyInfo, OMResponse omResponse)
      throws IOException {
    return new S3PutObjectTaggingResponseWithFSO(omResponse, omKeyInfo,
